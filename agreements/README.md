...
1. [Work becomes ownership](components/1-work-becomes-ownership.md)
...
- Equity record: all our own, in GovKit. Later, the Slicing Pie API or a Fairmint-style token.
- Signatures: <https://cooperation.org/letters> is one candidate to reuse.
