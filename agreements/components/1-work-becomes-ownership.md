...
> The total TEAMCOOK to be issued at each period shall be made public at least 7 days prior
> to being issued in order to allow time for any objections to be registered. TEAMCOOK shall
...
> Remember to also **set the story points equal to the number of hours worked** on each
> task. These will later translate to equity.

> the main thing is we use a task tracker to drop the equity without any overhead of
> deciding - just put hours on tasks · [SRC: project owner, 2026-07-16]

## Numbers

| | |
|---|---|
| Issued no more often than | 14 days |
| Issued no less often than | 90 days |
| Published before issuance | 7 days |
| Cap per 30 days | 10% of existing total |

## In GovKit

Drop run, adjustment with reason, immutable issued lines, pie with drill-down to tasks.
[docs/governance-practices.md](../../docs/governance-practices.md#1-drops--turning-approved-work-into-earned-equity)
