...
|---|---|
| Seats | 3 |
| Rotation | one seat per period |
| Weight window | same as voting |
| Role | advisory |

## In GovKit

`SortitionDraw` records seats, window, seed, result and the weights used; same seed over
the same weights gives the same outcome.

> Milestone 2: data model in place, draw page being built.
