...
> by the Tokens Smart Contract further described on the Site.

> "Rolling SAFE Equity Percentage" means 50%, provided that the Company may, in its sole
> discretion, increase the Rolling SAFE Equity Percentage... but in no event shall it
...
Now: all our own, in GovKit · [SRC: project owner, 2026-09-23]

Later: the Slicing Pie API, or tokenize the economic side like a Fairmint rolling SAFE.
The value unit is a per-org setting.
