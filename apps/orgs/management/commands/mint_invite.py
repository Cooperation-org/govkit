...
from apps.orgs.models import Invite, InviteAudience, MembershipRole, Org
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--role', default=MembershipRole.MEMBER,
            choices=[c for c, _ in MembershipRole.choices])
        parser.add_argument(
            '--audience', default=InviteAudience.SUPPORTER,
